package com.acme.loyalsips.platform.iam.interfaces.rest;

import com.acme.loyalsips.platform.iam.domain.services.UserCommandService;
import com.acme.loyalsips.platform.iam.interfaces.rest.resources.AuthenticatedUserResource;
import com.acme.loyalsips.platform.iam.interfaces.rest.resources.SignInResource;
import com.acme.loyalsips.platform.iam.interfaces.rest.resources.SignUpResource;
import com.acme.loyalsips.platform.iam.interfaces.rest.resources.UserResource;
import com.acme.loyalsips.platform.iam.interfaces.rest.transform.AuthenticatedUserResourceFromEntityAssembler;
import com.acme.loyalsips.platform.iam.interfaces.rest.transform.SignInCommandFromResourceAssembler;
import com.acme.loyalsips.platform.iam.interfaces.rest.transform.SignUpCommandFromResourceAssembler;
